...
Актуальная реализация и подтверждённые проверки описаны в [README](README.md)
и [протоколе приёмки](docs/acceptance.md). Дальнейший текст сохраняет исходное
распределение ответственности; первоначальные замечания о неготовом коде
описывают момент планирования. По прямому запросу Максима агент также выполняет
доработки зон 1 и 3 в отдельных ветках, сохраняя настоящее авторство изменений.
